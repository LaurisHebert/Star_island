...
<header>
    <nav id="navBar" class="navbar navbar-expand-lg sticky-top bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="/projets/Star_island/public/"><img
                        src="./<?= $data->searchMediaByType('mainLogo')['0']->path ?>" width="75" height="50"
                        class="d-inline-block align-text-top" alt=""></a>
